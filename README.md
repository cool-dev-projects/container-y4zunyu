...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y4zunyu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y4zunyu.containers.anotherwebservice.com/
...
```
git clone git@github.com:cool-dev-projects/container-y4zunyu.git
cd container-y4zunyu
```
...
```
docker attach container-y4zunyu
```
